...
//	LocalDeMusicaDaoJ localJ;
	...
	public void run(String... args) throws Exception {
		 ...
		 * String marcasGuitarras = "Ibanez, Shecter";
		 * 
		 * LocalDeMusicaJ local = new LocalDeMusicaJ("MusicMan",
		 * "av. del libertador 23201", 35, marcasGuitarras, marcasBajos, marcasBaterias,
		 * 1250.50, true);
		 * 
		 * localJ.save(local);
		 ...
		 * 
		 * LocalDeComida foodStore = new LocalDeComida("Wallito", "Carabobo 2244",
		 * 20000, marcasPizzas, marcasHamburguesas, 1800, 12000);
		 * 
